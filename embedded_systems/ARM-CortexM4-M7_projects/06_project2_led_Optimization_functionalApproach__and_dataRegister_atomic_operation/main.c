...
/*
 * @function initializeLEDGlobalData
 * @brief Initializing global data for Port-F
 *        LED sequences.
 * @return void.
 *
 */
...
/*
 * @function configureLEDPinsOnGPIOPortF
 * @brief Configuring pins on Port-F for LED sequences.
 *
 * @return void.
 *
 */
...
/*
 * @function runLEDSequence
 * @brief LED run sequence setup.
 *
 * @return void.
 *
 */
