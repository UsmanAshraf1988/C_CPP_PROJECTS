...
unsigned int Bad_Memory_Address;
unsigned int Bad_Instruction_Address;
void print_MPU_dump( void)
{
  trace_printf ("MPU Fault PC=%08X Memory Address:%08X\n", Bad_Instruction_Address, Bad_Memory_Address);
}
/**
...
void __attribute__ ((section(".after_vectors"),naked)) MemManage_Handler(void)
{
  ...
  // Check Bad_Memory_Adress and Bad_Instruction_Address !
  __asm volatile
  (
      " tst lr, #4                      \n"
      " ite eq                          \n"
      ...
      " str r1, [r2]                    \n"
      " ldr r2, Bad_Memory_Address_const \n"
      " ldr r1, MMFAR_const		\n"
      " ldr r1, [r1]			\n"
      " str r1, [r2]			\n"
      " bl print_MPU_dump		\n"
      ...
      " Bad_Memory_Address_const: .word Bad_Memory_Address   \n"
      " MMFAR_const: .word 0xe000ed34\n"
